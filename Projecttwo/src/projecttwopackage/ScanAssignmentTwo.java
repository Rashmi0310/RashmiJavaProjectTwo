...
public class ScanAssignmentTwo {
...
// object creation
			ScanAssignmentTwo obj = new ScanAssignmentTwo();
...
// call Sum
			int Sum = obj.Sum(Sub, x3);
			System.out.println(" Enter the value of x4");
			int x4 = obj1.nextInt();
			
// call multiply
			int Multiply = obj.Multiply(x4, Sub);
			System.out.println(" Enter the value of x5");
			int x5 = obj1.nextInt();
			
// Call sub1
			int Sub1 =obj.Sub(Multiply, x5);
			System.out.println(" Enter the value of x6");
			int x6 =obj1.nextInt();

// call divide
			int div = obj.div(Sub1, x6);
